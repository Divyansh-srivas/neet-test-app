...
export default function InteractiveMcqRunner({ 
  ...
  const { user } = useAuth();
  const [bookmarks, setBookmarks] = useState(() => new Set(getBookmarks(user?.uid).map(b => b.id)));
  ...
  const toggleBookmark = () => {
    toggleStorageBookmark(user?.uid, question);
    ...
    <div className="mcq-runner-container">
      ...
      <div className="mcq-main-content">
        <div className="mcq-question-card">
          ...
          <h2 className="mcq-question-text"><MathText text={question.questionText || question.question} /></h2>
            ...
            {question.options.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mcq-option-text"><MathText text={opt.text} /></div>
